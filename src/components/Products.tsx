        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          {canEditCatalog && (
            <button
              ...
              className="px-3 py-1.5 bg-emerald-800 hover:bg-emerald-950 text-white rounded-lg text-xs font-semibold flex items-center gap-1 shadow-sm cursor-pointer"
            >
